...
EPOCHS = 90
BATCH_SIZE = 256 # simclr 256, others 128, segformer 16 
LR = 2.5e-4 # 0.1 for resnet, 1e-3 for Eformer, 1e-1 for EformerV2, 0.256 for EfNet, 0.001 for EfNet_pt, 0.0003 for simclr, 5e-04 for swinv2, 5e-5 for segformer
